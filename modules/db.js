...
db.serialize(function() {
	...
	db.run('create table if not exists devices (id integer primary key, name text not null, ip text, mac text, tags text, description text, json_protocols text, is_ping integer, period integer)');
